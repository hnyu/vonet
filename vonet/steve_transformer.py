# Code of this file is taken from https://github.com/singhgautam/steve
...
def linear(in_features, out_features, bias=True, weight_init='xavier',
           gain=1.):
...
class TransformerDecoderBlock(nn.Module):
    def __init__(self,
        ...
        self.self_attn_mask = torch.triu(
